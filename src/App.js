...
import Dea4 from './dea4';
import Dea5 from './dea5';
import Dea6 from './dea6';
import Dea7 from './dea7';
      ...
      <Router>
        <div className="App1">
          ...
          <Routes>
            ...
            <Route path="/dea4" element={<Dea4 />} />
            <Route path="/dea5" element={<Dea5 />} />
            <Route path="/dea6" element={<Dea6 />} />
            <Route path="/dea7" element={<Dea7 />} />
